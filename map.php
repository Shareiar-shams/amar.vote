...
<!--========================== end s-header =========================-->
    <style type="text/css">
      ...
      .box-part a:hover{text-decoration: none; color: #4183D7;}
      .box-part a:hover .title h4{text-decoration: none; color: #4183D7;}
      .box-part a{text-decoration:none;color: #000;border-bottom: none;display: -webkit-flex;display: -moz-flex;display: -ms-flex;display: -o-flex;display: flex;-webkit-flex-direction: column;-moz-flex-direction: column;-ms-flex-direction: column;-o-flex-direction: column;flex-direction: column;}
      .box-part a .text{margin: 0;}
      .box-part a .title{margin: 0;}
      .box-part a .text h2{margin: 0;}
      .box-part a .title h4{margin: 0;}
      .box{padding:60px 0px;}
      .box-part{border-radius:0;padding:60px 10px;margin:30px 0px;}
      .box-part{padding:60px 10px;margin:30px 0;box-shadow:1px 1px 6px -2px #000;border-radius:10px}
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="d-flex flex-column">
                  <h3 class="text-center">আসনের তথ্য জানতে নিচে থাকে আসন নির্বাচন করুন ।</h3>
                  <div class="bordered-map">
                    ...
                    <!--      <label class="mr-sm-2" for="inlineFormCustomSelect">বিভাগ</label>-->
                    ...
                    <!--        <option value="4">সিলেট</option>-->
                    <!--        <option value="5">বরিশাল</option>-->
                    <!--        <option value="6">খুলনা</option>-->
                    ...
                    <div class="form-row align-items-center">
                      <div class="col-12 my-1">
                        <label class="mr-sm-2" for="inlineFormCustomSelect">জেলা</label>
                        <select name="district_name" class="custom-select mr-sm-2 district" id="inlineFormCustomSelect">
                          <option value="" selected>নির্বাচন করুন...</option>
                    ...
                    <!--<div class="form-row align-items-center">-->
                    <!--  <div class="col-12 my-1">-->
                    <!--    <label class="mr-sm-2" for="inlineFormCustomSelect">নির্বাচন এলাকা</label>-->
                    <!--    <select name="electopnArea" class="custom-select mr-sm-2" id="inlineFormCustomSelect">-->
                    <!--      <option value="" selected>নির্বাচন করুন...</option>-->
                    ...
                    <div class="form-row align-items-center">
                      <div class="col-12 my-1">
                        <button type="submit" class="btn btn-primary float-right">সম্পূর্ণ তথ্য দেখুন</button>
                      </div>
                    </div>
                    ...
                    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 800 1000" style="enable-background:new 0 0 800 1000;" xml:space="preserve">
                        ...
                        <a href="?district_name=সাতক্ষীরা">
                        	<g id="dist_274">
                        		<g>
                        ...
                        <a href="?district_name=পটুয়াখালী">
                        	<g id="dist_355">
                        	<g>
                        ...
                        <a href="?district_name=লক্ষ্মীপুর">
                        ...
                        <a href="?district_name=রাঙ্গামাটি">
                        ...
                        <a href="?district_name=চট্রগ্রাম">
                        	<g id="dist_55">
                        		<g>
                        ...
                        <a href="?district_name=শরীয়তপুর">
                        	<g id="dist_410">
                        ...
                        <a href="?district_name=মুন্সিগঞ্জ">
                        ...
                        <a href="?district_name=নারায়ণগঞ্জ">
                        ...
                        <a href="?district_name=মানিকগঞ্জ">
                        	<g id="dist_374">
                        ...
                        <a href="?district_name=কিশোরগঞ্জ">
                        ...
                        <a href="?district_name=মৌলভীবাজার">
                        ...
                        <a href="?district_name=সিরাজগঞ্জ">
                        	<g id="dist_281">
                        ...
                        <a href="?district_name=কুষ্টিয়া">
                        	<g id="dist_272">
                        ...
                        <a href="?district_name=গাইবান্ধা">
                        	<g id="dist_322">
                        ...
                        <a href="?district_name=কুড়িগ্রাম">
                        	<g id="dist_301">
                        ...
                        <a href="?district_name=ব্রাহ্মণবাড়িয়">
                        	<g id="dist_328">
                        ...
                        <a href="?district_name=ময়মনসিংহ">
                        ...
                        <a href="?district_name=বান্দরবান">
                        ...
                        <a href="?district_name=সুনামগঞ্জ">
                        ...
                        <a href="?district_name=লালমনিরহাট">
                        	<g id="dist_356">
                        ...
                        <a href="?district_name=ঠাকুরগাঁও">
                        ...
                        <a href="?district_name=নীলফামারী">
                        	<g id="dist_283">
                        ...
                        <a href="?district_name=জয়পুরহাট">
                        ...
                        <a href="?district_name=গোপালগঞ্জ">
                        ...
                        <a href="?district_name=মাদারীপুর">
                        ...
                        <a href="?district_name=চাঁপাইনবাবগঞ্জ">
                        	<g id="dist_343">
                        ...
                        <a href="?district_name=নেত্রকোনা">
                        ...
                        <a href="?district_name=চুয়াডাঙ্গা">
                        ...
                        <a href="?district_name=কক্সবাজার">
                        	<g id="dist_264">
            ...
            <?php if ($districtQuery): ?>
            
            <?php $idstrictData = $districtQuery->fetch_object(); ?>
            
            <div class="col-md-6">
                <div class="row">
                    <div class="col-md-12">
                        <h3 class="text-center"><?= $idstrictData->district_name; ?></h3>
                    </div>
                </div>
              <div class="row">
                <div class="col-md-6">
                  <div class="box-part text-center alert-success">
                    <a class="" href="#">
                      ...
                      <div class="title">
                        <h4><?= $idstrictData->total_voter; ?></h4>
                      </div>
                    </a>
                  </div>
                </div>   
                ...
                <div class="col-md-6 ">
                  ...
                  <div class="box-part text-center alert-danger">
                    <a href="#">
                      <i class="fas fa-male fa-3x" aria-hidden="true"></i>
                      <div class="text">
                        <h4>পুরুষ ভোটার</h4>
                        <div class="title">
                          <h4><?= $idstrictData->male_voter; ?></h4>
                        </div>
                      </div>
                    </a>
                  </div>
                ...
                <div class="col-md-6">
                  <div class="box-part text-center alert-danger">
                    <a href="#">
                      <i class="fas fa-female fa-3x" aria-hidden="true"></i>
                      <div class="text">
                        <h4>নারী ভোটার</h4>
                      </div>
                      <div class="title">
                        <h4><?= $idstrictData->female_voter; ?></h4>
                      </div>
                    </a>
                  </div>
                </div>   
