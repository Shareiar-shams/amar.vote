...
$apiURL= file_get_contents('https://newsapi.org/v2/everything?q=bangladesh%20election&apiKey=9b985242ab2b4a169b895f4944db16f8'.$pageNo.'0');
            ...
            <?php foreach ($data->newslist as $key => $value): ?>
                <div class="post-slide my-3 d-flex">
                    ...
                    <div class="post-review">
                        <h3 class="post-title"><a href="<?= $value->url; ?>"><?= $value->title; ?></a></h3>
                        <ul class="post-bar">
