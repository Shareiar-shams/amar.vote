...
<head>
    ...
    <link rel="stylesheet" href="https://smmplsc.edu.bd/wp-content/themes/ditsmmplsc/fonts/stylesheet.css">
    ...
    <section id="home" class="s-home target-section" data-parallax="scroll" data-image-src="/images/shapla.jpg" data-natural-width=3000 data-natural-height=2000 data-position-y=center>
        ...
        <div class="home-content">
            ...
            <div class="row home-content__main">
                <div class="col-full wall">
                    <h3>#আমারভোট </h3>

                    <h1>কেমন বাংলাদেশ চাই? তৈরি করুন জনতার ইশতিহার </h1>
                </div>
                
                <div class="col-full vote_list_box" id="vot-tricker">
                     <ul >
                    <?php
                        $i = 1;
                    ...
                    <div class="card-body card_design">
                        ...
                        <a href="#" class="btn_custom info">Total Supports : <span class="voteNo"><?php echo $data['like_count'];?></span></a>
                        <a href="/manifesto/?topic=<?php echo $data['topic'];?>&search_topic=submit" class="btn_custom danger"><strong> Topic : </strong><?php echo $data['topic'];?></a>
                    </div>
                     <?php } ?>
                    </ul >
                </div>
                    ...
                    <fieldset>
                        ...
                        <div id="allFields">
                            <div class="form-field">
                                <input name="name" type="text" id="name" placeholder="আপনার নাম" value="" class="full-width">
                            </div>
                            
                            <div class="form-field">
                                <input name="phone" type="number" id="number" placeholder="আপনার ফোন নম্বর" value=""  class="full-width">
                            </div>
                            
                            <div class="form-field">
                                <input name="email" type="email" id="email" placeholder="আপনার ইমেইল" value="" class="full-width">
                            </div>
                            ...
                            <div class="form-row form-field">
                                <div class="form-group">
                                      <select name="election_area" class="form-control js-example-basic-single full-width topic" id="exampleFormControlSelect1">
                                          <option value="">-- আপনার নির্বাচনী এলাকা (ঐচ্ছিক) --</option>
                                          <?php
                            ...
                            <div class="form-group">
                                <select name="topic[1]" class="full-width topic">
                                    <option value="">-- টপিক --</option>
                                    <option value="Education">শিক্ষা</option>
                                    <option value="Health">স্বাস্থ্য</option>
                                    <option value="Employment">কর্মসংস্থান</option>
                                    <option value="Youth">যুব উন্নয়ন</option>
                                    <option value="Freedom of Speech">বাক স্বাধীনতা</option>
                                    <option value="Women Issue">নারী উন্নয়ন</option>
                                    <option value="Children Issue">শিশু বিষয়ক</option>
                                    <option value="Liberation War">মুক্তিযুদ্ধ বিষয়ক</option>
                            ...
                            <div class="form-field">
                                <textarea name="comment[1]" id="contactMessage" placeholder="আপনার বার্তা / ইশতিহার" rows="5" cols="50" class="full-width"></textarea>
                            </div>
                            
                        </div>
                    
                    <div class="input_fields_wrap">
                        <button class="add_field_button">আরও পয়েন্ট যুক্ত করুন </button>
                    </div>
                    
                    <div class="form-field">
                        <button class="full-width btn--primary" type="submit" name="submit_vote">সাবমিট</button>
