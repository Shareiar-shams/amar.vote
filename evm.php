      ...
      <div class="row" style="margin-top: 96px;">
        <div class="container mt-5">
          <div class="row text-center">
            <div class="col-md-10 mx-a">
                <h3>ডিজিটাল পদ্ধতিতে ইভিএম দিয়ে কিভাবে ভোট দিবেন</h3>
                <hr>
                
                <iframe style="width:100%" width="100%" height="490" src="https://www.youtube.com/embed/k1PC2oHcUKo" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
        </div>
      </div>
  </div>
